...
class OfferSummaryRecyclerViewAdapter(val horizontalGrocderyList: List<ProductItem>, internal var context: Context) : RecyclerView.Adapter<OfferSummaryRecyclerViewAdapter.GroceryViewHolder>() {
