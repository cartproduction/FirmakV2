...
class ProductCategoryRecyclerViewAdapter(val horizontalGrocderyList: List<ProductItem>, internal var context: Context) : RecyclerView.Adapter<ProductCategoryRecyclerViewAdapter.GroceryViewHolder>() {
