...
class AnnouncementRecyclerViewAdapter(val horizontalGrocderyList: List<ProductItem>, internal var context: Context) : RecyclerView.Adapter<AnnouncementRecyclerViewAdapter.GroceryViewHolder>() {
