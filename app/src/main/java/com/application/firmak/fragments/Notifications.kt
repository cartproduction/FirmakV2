...
import com.application.firmak.adapters.AnnouncementRecyclerViewAdapter
...
class Notifications: Fragment() {
    ...
    private var productAdapter: AnnouncementRecyclerViewAdapter? = null
    ...
    private fun initProductRecycleView() {
        ...
        productAdapter = AnnouncementRecyclerViewAdapter(productArray, requireContext())
