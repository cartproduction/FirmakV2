...
class ServiceList: Fragment() {
    ...
    private fun initProductRecycleView() {
        ...
        productAdapter = ServiceRecyclerViewAdapter(productArray, requireContext())
